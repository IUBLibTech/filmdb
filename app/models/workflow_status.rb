class WorkflowStatus < ActiveRecord::Base
  ...
  STATUS_TYPES_TO_STATUSES = {
	...
	STATUSES_TO_NEXT_WORKFLOW = {
		...
		PULL_REQUESTED => (PULLABLE_STORAGE + [IN_WORKFLOW_WELLS, BEST_COPY_ALF, BEST_COPY_WELLS, BEST_COPY_MDPI_WELLS, ISSUES_SHELF, TWO_K_FOUR_K_SHELVES, DEACCESSIONED, MOLD_ABATEMENT]),
		...
		BEST_COPY_WELLS => (PULLABLE_STORAGE + [DEACCESSIONED, MOLD_ABATEMENT]),
		BEST_COPY_MDPI_WELLS => (PULLABLE_STORAGE + [WELLS_TO_ALF_CONTAINER, MOLD_ABATEMENT]),
		IN_WORKFLOW_WELLS => ((PULLABLE_STORAGE + [MOLD_ABATEMENT]) + [SHIPPED_EXTERNALLY, DEACCESSIONED]),
		WELLS_TO_ALF_CONTAINER => [TWO_K_FOUR_K_SHELVES],
