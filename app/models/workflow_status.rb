class WorkflowStatus < ActiveRecord::Base
  ...
  STATUS_TYPES_TO_STATUSES = {
		...
		'In Workflow' => [QUEUED_FOR_PULL_REQUEST, PULL_REQUESTED, RECEIVED_FROM_STORAGE_STAGING, TWO_K_FOUR_K_SHELVES, ISSUES_SHELF,
		                  BEST_COPY_ALF, BEST_COPY_WELLS, BEST_COPY_MDPI_WELLS, IN_CAGE, IN_WORKFLOW_WELLS, JUST_INVENTORIED_WELLS,
											JUST_INVENTORIED_ALF, MOLD_ABATEMENT, WELLS_TO_ALF_CONTAINER],
	...
	STATUSES_TO_NEXT_WORKFLOW = {
		...
		DEACCESSIONED => [],
		JUST_INVENTORIED_WELLS => [IN_STORAGE_AWAITING_INGEST, IN_STORAGE_INGESTED, AWAITING_FREEZER, IN_WORKFLOW_WELLS, IN_FREEZER, MISSING, MOLD_ABATEMENT, ISSUES_SHELF],
		JUST_INVENTORIED_ALF => [IN_STORAGE_AWAITING_INGEST, IN_STORAGE_INGESTED, IN_FREEZER, AWAITING_FREEZER, MOLD_ABATEMENT, RECEIVED_FROM_STORAGE_STAGING, BEST_COPY_ALF, MISSING, ISSUES_SHELF]
	}
  ...
  def in_workflow?
	...
	def update_physical_object
		physical_object.update_attributes!(current_workflow_status_id: id);
	end
