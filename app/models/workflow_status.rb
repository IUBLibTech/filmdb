class WorkflowStatus < ActiveRecord::Base
  ...
  STATUS_TYPES_TO_STATUSES = {
	...
	STATUSES_TO_NEXT_WORKFLOW = {
		...
		DEACCESSIONED => [],
		JUST_INVENTORIED_WELLS => [IN_STORAGE_AWAITING_INGEST, IN_STORAGE_INGESTED, AWAITING_FREEZER, IN_WORKFLOW_WELLS, IN_FREEZER, MISSING, MOLD_ABATEMENT, ISSUES_SHELF, WELLS_TO_ALF_CONTAINER],
