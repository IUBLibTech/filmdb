class WorkflowStatus < ActiveRecord::Base
	...
	ALL_STATUSES = [IN_STORAGE_INGESTED, IN_STORAGE_AWAITING_INGEST, IN_FREEZER, AWAITING_FREEZER, MOLD_ABATEMENT, MISSING,	IN_CAGE, QUEUED_FOR_PULL_REQUEST,	PULL_REQUESTED,
	                ...
	                JUST_INVENTORIED_ALF, BEST_COPY_WELLS]
  ...
  STATUS_TYPES_TO_STATUSES = {
		...
		'In Workflow' => [QUEUED_FOR_PULL_REQUEST, PULL_REQUESTED, RECEIVED_FROM_STORAGE_STAGING, TWO_K_FOUR_K_SHELVES, ISSUES_SHELF, BEST_COPY_ALF, BEST_COPY_WELLS, IN_CAGE, IN_WORKFLOW_WELLS, JUST_INVENTORIED_WELLS, JUST_INVENTORIED_ALF, MOLD_ABATEMENT],
	...
	STATUSES_TO_NEXT_WORKFLOW = {
		...
		PULL_REQUESTED => (PULLABLE_STORAGE + [IN_WORKFLOW_WELLS, BEST_COPY_ALF, BEST_COPY_WELLS, ISSUES_SHELF, TWO_K_FOUR_K_SHELVES, DEACCESSIONED, MOLD_ABATEMENT]),
		RECEIVED_FROM_STORAGE_STAGING => [TWO_K_FOUR_K_SHELVES],
		TWO_K_FOUR_K_SHELVES => [IN_CAGE],
		ISSUES_SHELF =>  ([TWO_K_FOUR_K_SHELVES, DEACCESSIONED, BEST_COPY_ALF] + (PULLABLE_STORAGE + [MOLD_ABATEMENT])),
		BEST_COPY_ALF => (PULLABLE_STORAGE + [MOLD_ABATEMENT] + [TWO_K_FOUR_K_SHELVES, DEACCESSIONED]),
		BEST_COPY_WELLS => (PULLABLE_STORAGE + [TWO_K_FOUR_K_SHELVES, DEACCESSIONED, MOLD_ABATEMENT]),
		...
		JUST_INVENTORIED_ALF => [IN_STORAGE_AWAITING_INGEST, IN_STORAGE_INGESTED, IN_FREEZER, AWAITING_FREEZER, MOLD_ABATEMENT, RECEIVED_FROM_STORAGE_STAGING, BEST_COPY_ALF]
	}
