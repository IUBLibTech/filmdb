...
(function ($, document, window) {
    ...
    // Convenience function for creating new_physical_object jQuery objects
    ...
    publicMethod.prep = function (object) {
        ...
        $loaded.hide()
            ...
            .css({height: getHeight()})// sets the height independently from the width in case the new_physical_object width influences the value of height.
            .prependTo($content);
    ...
    function load () {
        ...
        if (settings.get('inline')) {
            ...
            // An event is bound to put inline content back when Colorbox closes or loads new_physical_object content.
...
g.bDestroy===true){E[a].oInstance.fnDestroy();break}else{J(E[a],0,"Cannot reinitialise DataTable.\n\nTo retrieve the DataTables object for this table, please pass either no arguments to the dataTable() function, or set bRetrieve to true. Alternatively, to destory the old table and create a new_physical_object one, set bDestroy to true (note that a lot of changes to the configuration can be made through the API which is usually much faster).");return}if(E[a].sTableId!==""&&E[a].sTableId==this.getAttribute("id")){E.splice(a,
